...
from bvlos_sim.adapters.cli_contract import __all__ as _contract_all
from bvlos_sim.adapters.cli_contract import (  # noqa: F401
...
def _register_commands() -> None:
    from bvlos_sim.adapters.commands.batch import batch
    from bvlos_sim.adapters.commands.calibrate import calibrate
    from bvlos_sim.adapters.commands.compare import compare
    from bvlos_sim.adapters.commands.convert import convert
    from bvlos_sim.adapters.commands.estimate import estimate
    from bvlos_sim.adapters.commands.export import export
    from bvlos_sim.adapters.commands.ingest_log import ingest_log
    from bvlos_sim.adapters.commands.migrate import migrate
    from bvlos_sim.adapters.commands.propagate import propagate
    from bvlos_sim.adapters.commands.sample import sample
    from bvlos_sim.adapters.commands.scenario import scenario
    from bvlos_sim.adapters.commands.schema_versions import schema_versions
    from bvlos_sim.adapters.commands.sitl import sitl
    from bvlos_sim.adapters.commands.size_battery import size_battery
    from bvlos_sim.adapters.commands.sora import sora
    from bvlos_sim.adapters.commands.validate import validate
    from bvlos_sim.adapters.commands.verify_evidence import verify
    ...
    if (source_root / "pyproject.toml").is_file() and (
        ...
        from bvlos_sim.adapters.commands.bump import bump
